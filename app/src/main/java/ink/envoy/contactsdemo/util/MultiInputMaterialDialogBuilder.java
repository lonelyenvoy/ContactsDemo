...
public class MultiInputMaterialDialogBuilder extends MaterialDialog.Builder {
    ...
    public MultiInputMaterialDialogBuilder test(CharSequence preFill, CharSequence hint) {
    ...
    public MultiInputMaterialDialogBuilder addInput(int inputType, CharSequence preFill, CharSequence hint) {
